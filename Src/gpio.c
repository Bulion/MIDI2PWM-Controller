...
void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOC, PWM6_Pin|PWM7_Pin|PWM8_Pin|PWM9_Pin 
                          |PWM10_Pin|PWM11_Pin|PWM12_Pin|PWM19_Pin 
                          |PWM20_Pin|PWM47_Pin|PWM48_Pin|PWM49_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, PWM23_Pin|PWM31_Pin|PWM32_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOD, PWM35_Pin|PWM36_Pin|PWM37_Pin|PWM38_Pin 
                          |PWM50_Pin|PWM51_Pin|PWM52_Pin|PWM53_Pin 
                          |PWM54_Pin|PWM55_Pin|PWM56_Pin|PWM57_Pin, GPIO_PIN_RESET);
  ...
  GPIO_InitStruct.Pin = PWM6_Pin|PWM7_Pin|PWM8_Pin|PWM9_Pin 
                          |PWM10_Pin|PWM11_Pin|PWM12_Pin|PWM19_Pin 
                          |PWM20_Pin|PWM47_Pin|PWM48_Pin|PWM49_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  ...
  GPIO_InitStruct.Pin = PWM23_Pin|PWM31_Pin|PWM32_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  ...
  GPIO_InitStruct.Pin = PWM44_Pin|PWM45_Pin|PWM46_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
